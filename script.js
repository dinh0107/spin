$(document).ready(function () {
    ...
    function getPosition(position) {
        if (position <= 30) {
            $('.congratulation__note').text('CHÚC MỪNG BẠN TRÚNG ĐƯỢC TRANG PHỤC RAZ MUAY THÁI');
        }
        else if (position <= 90) {
            $('.congratulation__note').text('CHÚC MỪNG BẠN TRÚNG ĐƯỢC TRANG PHỤC Butterfly PHƯỢNG CỬU THIÊN');
        }
        else if (position <= 150) {
            $('.congratulation__note').text('CHÚC MỪNG BẠN TRÚNG ĐƯỢC TRANG PHỤC Lauriel THỨ NGUYÊN VỆ THẦN');
        } else if (position <= 210) {
            $('.congratulation__note').text('CHÚC MỪNG BẠN TRÚNG ĐƯỢC TRANG PHỤC AIRI BÍCH HẢI THẦN NỮ');
        } else if (position <= 270) {
            $('.congratulation__note').text('CHÚC MỪNG BẠN TRÚNG ĐƯỢC TRANG PHỤC Nakroth THỨ NGUYÊN VỆ THẦN');
        }
        else if (position <= 330) {
            $('.congratulation__note').text('CHÚC MỪNG BẠN TRÚNG ĐƯỢC TRANG PHỤC Tulen Chí Tôn Tiên Kiếm');
        }
        else {
            $('.congratulation__note').text('CHÚC MỪNG BẠN TRÚNG ĐƯỢC TRANG PHỤC Tulen Chí Tôn Tiên Kiếm');
        }
